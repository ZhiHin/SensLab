  ...
  return (
    <main id="main" className="mx-auto flex w-full max-w-[900px] flex-col gap-6 px-6 py-12">
      <header className="flex flex-col gap-2">
        ...
        <h1 className="type-display-s">YOUR SETTINGS</h1>
        {view.verdict === "indistinguishable" && (
          <p className="max-w-[64ch] text-sm text-text-2">
            ...
            {targetCm.toFixed(1)} cm/360. Anything in the range is fine.
          </p>
        )}
      </header>
      ...
      <Panel title="What you can use anywhere">
        <dl className="flex flex-col gap-3">
          <div className="flex items-baseline justify-between gap-4 border-b border-hairline pb-3">
            <dt className="type-label text-text-2">Target</dt>
            <dd className="flex items-center gap-3">
              ...
              <CopyButton value={targetCm.toFixed(1)} label="target cm per 360" />
            </dd>
          </div>
          <div className="flex items-baseline justify-between gap-4 border-b border-hairline pb-3">
